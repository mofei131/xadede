...
if ($cfg_feedback_forbid=='N' AND !empty($client_id)) {
    ...
    ShowMsg("已经禁用XingaoCMS默认评论，开启畅言评论！","?");
    exit();
}
...
<table width="98%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    ...
    <tr>
      ...
      <td width="84%" style="text-align:left;"><input name="url" type="text" id="url" size="16" style="width:200px" value="{$cfg_basehost}" /><span style="color:#999">&nbsp; 例如：http://www.sdxingao.com.cn</span></td>
    </tr>
  </tbody>
</table>
EOT;
